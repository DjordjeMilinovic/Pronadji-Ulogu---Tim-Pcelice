...
(7, 7, 'djoxon', 'Koleginice, zaista divno napisano, zbog Vas sam dobio želju da pročitam roman! :)', '2021-06-06'),
(8, 10, 'pance', 'Veoma nekorektno sa njegove strane. Da sam na tvom mestu ne bih se prijavljivala!', '2021-06-06'),
(9, 10, 'mixusmaxus', 'Postoje i drugi reditelji na ovom sajtu, slobodno pogledaj preostale okačene kastinge ;)', '2021-06-06');
...
('djoxon', 'lozinka123', '2000-01-14', 'Đorđe', 'Milinović', 'md180334@student.etf.bg.ac.rs'),
...
(10, 'Reziser nije platio honorare', 'visnja', 'polemika oko filma ,,12 Ljutih gusara’’', 'Pre 10 dana pušten je u promet film ,,12 Ljutih gusara’’ u režiji Nikole Nikolića. Film je za veoma kratko vreme pogledao veliki broj ljudi, bioskopske sale su pune, karte je veoma teško naći usled popularnosti ovog filma. Pre neki dan sam i sam otišao da ga pogledam i veoma mi se svideo. Radnja, muzika, glumci, efekti – sve je savršeno na mestu. Međutim, doznah od nekih svojih prijatelja da veliki broj glumaca i dalje nije plaćeno za svoje uloge i da režiseru filma ne pada na pamet da ih isplati, već da je on jedan veliki ,,prevarant’’. S’ obzirom na to da je objavio nekoliko kastinga na ovom sajtu, i da sam i sam razmišljao da se prijavim za neke od njih, zanima me da li možda neko zna nešto više o tome?', '2021-06-06');
