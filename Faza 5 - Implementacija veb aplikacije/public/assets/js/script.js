...
function loginerror(message, username) {
    switch (message) {
        ...
        case 'Zahtev za registraciju na cekanju':
            document.getElementById('KorisnickoIme').placeholder = message;
            break;
        case "Zahtev za registraciju odbijen":
            document.getElementById('KorisnickoIme').placeholder = message;
            break;
    }
}
...
function DirectorRequest(Reditelj, Odluka) {
    ...
    $.ajax({
        ...
        dataType: 'json',
        data: {
            Reditelj: Reditelj, Odluka: Odluka
        },
        complete: function (data) {
            myobj.remove();
        }
...
function filterPrikaz() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        data: {
            ActorType: num, Tip: tip, Controller: controler
        },
        complete: function ($data) {
...
function dodajKomentar() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        data: {
            idTeme: idTeme, NewComment: komentar, Controller: controler
        },
        complete: function ($data) {
